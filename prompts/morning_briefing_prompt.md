...
- Markiere ein Thema als `mehrfach bestaetigt`, wenn es in mehreren Quellen vorkommt.
- Markiere ein Thema als `Einzelquelle`, wenn es nur aus einer Quelle stammt.
